...
var n = (t2, e) => {
  for (var a2 in e || (e = {})) x.call(e, a2) && d(t2, a2, e[a2]);
...
function b(e, t2, n2 = /* @__PURE__ */ new WeakSet()) {
  ...
  let R = Object.keys(e);
  if (f2 = R.length, f2 !== Object.keys(t2).length) return false;
  for (u2 = f2; u2-- !== 0; ) if (!Object.prototype.hasOwnProperty.call(t2, R[u2])) return false;
  for (u2 = f2; u2-- !== 0; ) if (T = R[u2], !b(e[T], t2[T], n2)) return false;
  return true;
}
function y(e, t2) {
  return b(e, t2);
...
//# sourceMappingURL=chunk-BVJK74FI.js.map
